...
#define default_highlightTextColor [UIColor colorWithRed:0.0 green:0.47843137 blue:1.0 alpha:1.0]

#define default_iconColor [UIColor colorWithWhite:0.57254902 alpha:1.0]
#define default_highlightIconColor [UIColor colorWithRed:0.0 green:0.47843137 blue:1.0 alpha:1.0]

#define default_backdropColor [UIColor clearColor]
#define default_highlightBackdropColor [UIColor clearColor]


@implementation ESTabBarItemContentView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        self.iconColor = default_iconColor;
        _highlightIconColor = default_highlightIconColor;
        self.backdropColor = default_backdropColor;
...
- (ESTabBarItemBadgeView *)badgeView
{
    if (!_badgeView) {
        _badgeView = [[ESTabBarItemBadgeView alloc] init];
    }
    return _badgeView;
}
